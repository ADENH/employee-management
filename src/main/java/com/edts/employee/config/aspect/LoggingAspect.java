...
public class LoggingAspect {
	...
	@Pointcut("within(com.edts.employee..controller..*)")
	...
	public Object logAdvice(ProceedingJoinPoint joinPoint) throws Throwable {
		...
		logger.info("Entered: {} () with arguments = {}", joinPoint.getSignature().getName(),
		...
		try {
			...
			logger.info("Exception {} in {}()", Arrays.toString(joinPoint.getArgs()),
